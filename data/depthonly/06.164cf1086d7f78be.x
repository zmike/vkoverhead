static VkPipeline
pso_164cf1086d7f78be(VkPipelineLayout layout, VkRenderPass renderPass, void *shader_ptr)
{
   ...
   colorBlendState_VkPipelineColorBlendAttachmentState[0] = (VkPipelineColorBlendAttachmentState){0, 6, 7, 0, 6, 7, 0, 15};
   ...
   PIPELINE_RENDERING_CREATE_INFO.depthAttachmentFormat = 130;
   PIPELINE_RENDERING_CREATE_INFO.stencilAttachmentFormat = 130;
   PIPELINE_RENDERING_CREATE_INFO.viewMask = 0;
   PIPELINE_RENDERING_CREATE_INFO.colorAttachmentCount = 1;
   VkFormat PIPELINE_RENDERING_CREATE_INFO_VkFormat[1];
   PIPELINE_RENDERING_CREATE_INFO_VkFormat[0] = VK_FORMAT_R8G8B8A8_SRGB;
